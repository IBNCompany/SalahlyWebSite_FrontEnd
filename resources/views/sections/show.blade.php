...
<head>
    ...
    <title>{{ $section->title ?? $section->meta_title }}</title>
...
<body class="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen font-cairo">
    ...
    <main class="container mx-auto px-4 py-12">
        ...
        <div class="relative mb-12 animate-fade-in-up">
            ...
            @else
                <div class="w-full h-64 flex items-center justify-center bg-gradient-to-br from-seeker-light to-provider-light rounded-2xl shadow-lg">
                    ...
                    <article class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 animate-fade-in-up border border-gray-200 overflow-hidden"
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex justify-between items-center">
                                <a href="{{ route('show_a_blog', $blog->slug) }}"
                                   class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-seeker-primary to-seeker-accent text-white font-semibold rounded-lg hover:from-seeker-accent hover:to-seeker-primary transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg">
                                    <span class="ml-2">اقرأ المزيد</span>
                                ...
                                <div class="flex items-center">
                                    @if($blog->status === 'published')
                                        ...
                                        <span class="text-xs text-gray-500 mr-2">منشور</span>
                                    @elseif($blog->status === 'draft')
                                        <div class="w-2 h-2 bg-yellow-500 rounded-full animate-pulse"></div>
                                        <span class="text-xs text-gray-500 mr-2">مسودة</span>
                                    @else
                                        <div class="w-2 h-2 bg-red-500 rounded-full animate-pulse"></div>
                                        <span class="text-xs text-gray-500 mr-2">مؤرشف</span>
                                    @endif
                                </div>
                            </div>
                        </div>
        ...
        @else
            <div class="text-center py-16 animate-fade-in-up">
                ...
                <h3 class="text-2xl font-bold text-gray-600 mb-4">لا توجد مقالات في هذا القسم حالياً</h3>
