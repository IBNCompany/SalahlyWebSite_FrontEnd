                ...
                <div>
                    ...
                    <select id="blog_section_id" name="blog_section_id"
                        ...
                        @foreach($sections as $section)
                            <option value="{{ $section->id }}" {{ old('blog_section_id' , $blog->blog_section_id) == $section->id ? 'selected' : '' }}>
                                {{ $section->title }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div id="content-details" class="space-y-6 transition-all duration-300 max-h-[1000px] opacity-100">
                ...
                <div>
                    ...
                    <textarea id="excerpt" name="excerpt" rows="3"
                              class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-seeker-primary focus:border-transparent transition-all duration-300">{{ old('excerpt' , $blog->excerpt) }}</textarea>
            ...
            <div id="publishing-settings" class="space-y-6 transition-all duration-300 max-h-[1000px] opacity-100">
                ...
                <div>
                    ...
                    <select id="status" name="status"
                        ...
                        <option value="archived" {{ old('status', $blog->status) == 'archived' ? 'selected' : '' }}>مؤرشف</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="datetime-local" id="published_at" name="published_at" value="{{ old('published_at', $blog->published_at) }}"
                           class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-seeker-primary focus:border-transparent transition-all duration-300">
            ...
            <div id="seo-settings" class="space-y-6 transition-all duration-300 max-h-[1000px] opacity-100">
                ...
                <div>
                    ...
                    <textarea id="meta_description" name="meta_description" rows="3"
                              class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-seeker-primary focus:border-transparent transition-all duration-300">{{ old('meta_description', $blog->meta_description) }}</textarea>
                ...
                <div>
                    ...
                    <textarea id="meta_keywords" name="meta_keywords" rows="2"
                              class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-seeker-primary focus:border-transparent transition-all duration-300">{{ old('meta_keywords', $blog->meta_keywords) }}</textarea>
